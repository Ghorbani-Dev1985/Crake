...
function JoinUS() {
  return (
    <Box className='container relative grid grid-cols-1 md:grid-cols-2 gap-10 my-20'>
      ...
      <img src={JoinUSImg}  alt='ghorbani-dev.ir' className='md:size-72 lg:size-auto' />
    </Box>
    <Box className='flex flex-col gap-2 relative z-20 px-4'>
         ...
         <ul className='text-slate-400 child:before:content-[""] child:relative child:before:absolute child:before:-right-5 child:before:top-1.5 child:before:block child:before:bg-slate-800 child:before:size-3 child:before:rounded-full'>
